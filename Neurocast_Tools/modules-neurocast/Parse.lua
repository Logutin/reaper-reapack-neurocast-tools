...
-- Parse.process_script_cast now uses shared modules-neurocast.Utf8Tools simple Unicode
...
--
-- Current boundary:
-- modules-neurocast.Utf8Tools owns reusable UTF-8 lowercase behavior.
